...
const socket = io(`https://ws.aztrading.info`,{});
...
export function subscribeOnStream(symbolInfo,
    interval,
    onRealtimeCallback,
    subscriberUID,
...
//         ...lastDailyBar,
//         open: parseFloat(i.open),
//         high:  Math.max(lastDailyBar.high, parseFloat(i.max)),
//         low: Math.min(lastDailyBar.low, parseFloat(i.min)),
//         close: parseFloat(i.close),
//         volume: parseFloat(i.volume)
//     }
// }
